import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QGraphicsScene, QGraphicsView, QGraphicsLineItem, QGraphicsTextItem
...
def get_json_info():
    info = json.loads(get_response())  # Assuming get_response() returns a JSON string
...
info, dates, descriptions, no_of_events = get_json_info()
